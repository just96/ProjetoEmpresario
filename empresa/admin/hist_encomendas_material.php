...
<title>Menu Gestor-Histórico de Material Enviado</title>
...
if ($result->num_rows > 0) {
	?>
	<body>
		<h1 align="center">Histórico de Material Enviado</h1>
		<hr>
		<br>
		<div class="d-flex justify-content-center">
			<button onclick="window.location.href='../pdf/pdf_hist_encomendas_material_admin.php'" type="submit" class="btn btn-warning" name="gerar_pdf">Gerar PDF&nbsp<img src="../img/pdf.png" width="30" height="30"></img></button>
		</div>
				...
				<tbody>
					<?php while($row = $result->fetch_assoc()) {
						...
						<tr>
							...
							<td><a onclick="return confirm('Ver esta encomenda?')" href="../funcoes_admin/ver_encomenda_material.php?&id_geral=<?php echo $row["id_encomenda"];?>"><img height="35" width="35" border="0" src="../img/ver_encomenda.png"></a></td></tr>
							<?php
						}?> 
					</tbody>
				</table>
