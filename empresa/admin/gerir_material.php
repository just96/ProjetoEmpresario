	...
	<body>
		...
		<div class="container-fluid">
			<div class="d-flex justify-content-center">
				<button onclick="window.location.href='../fpdf/pdf_materiais_admin.php'" type="submit" class="btn btn-warning">Gerar PDF&nbsp<img src="../img/pdf.png" width="25" height="25"></img></button>
			</div>
			<br>
