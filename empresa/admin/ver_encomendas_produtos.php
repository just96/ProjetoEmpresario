				...
				<tbody>
					<?php while($row = $result->fetch_assoc()) {
						...
						<tr>
							...
							<td><a onclick="return confirm('Ver esta encomenda?')" href="../funcoes/ver_encomenda_produto.php?&id_geral=<?php echo $row["id_encomenda"]?>"><img height="35" width="35" border="0" src="../img/ver_encomenda.png"></a></td>
