      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="../utilizador/encomendar_material.php">Encomendar Material</a>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="../utilizador/adicionar_cliente.php">Adicionar</a>
              <a class="dropdown-item" href="../utilizador/gerir_clientes.php">Gerir</a>
            </div>
          </li>
        </ul>
