...
$sql = "SELECT id_encomenda,id_material,nome_fiscal,data_encomenda,comentario,autorizada FROM `encomendas` INNER JOIN `clientes` ON encomendas.id_cliente = clientes.id_cliente WHERE autorizada LIKE '0' AND id_material IS NOT NULL GROUP BY id_encomenda ASC;";
				...
				<tbody>
					<?php while($row = $result->fetch_assoc()) {
						...
						<tr>
							...
							<td><a onclick="return confirm('Autorizar esta encomenda?')" href="../funcoes_admin/autorizar_encomenda.php?&id_geral=<?php echo $row["id_encomenda"] ?>"><img height="35" width="35" border="0" src="../img/check.png"></td>
