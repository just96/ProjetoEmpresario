...
class myPDF extends FPDF{
    ...
    function headerTable(){
        ...
        $this->Cell(100,10,'Nome do Material',1,0,'C');
        $this->Ln();
    }
    function viewTable($db){
        ...
        while($data = $stmt->fetch(PDO::FETCH_OBJ)){
            $this->Cell(30,10,iconv("UTF-8", "ISO-8859-1",$data->tipo),1,0,'L');
            $this->Cell(100,10,iconv("UTF-8", "ISO-8859-1",$data->nome_material),1,0,'L');
            $this->Ln();
        }
    }
}
